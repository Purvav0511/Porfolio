  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">The following projects showcases my experience and my skills through real-world examples of my work.
